...
def populate():
	...
	add_page(python_cat, title= "Official Python Tutorial", url= "http://docs.python.org/2/tutorial/")
	...
	add_page(cat=django_cat, title="Official Django Tutorial", url="https://doc.djangoproject.com/en/1.5/intro/tutorial01/")
